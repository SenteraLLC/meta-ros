...
SRC_URI = "https://github.com/ros2-gbp/ament_lint-release/archive/release/dashing/ament_cmake_clang_tidy/0.7.8-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "51410b4c3b3c029037b9901773a85c9f"
SRC_URI[sha256sum] = "fab7b8cd4331726e4e48b913752034c8ca5787618818b95976d54ed8099f56eb"
S = "${WORKDIR}/ament_lint-release-release-dashing-ament_cmake_clang_tidy-0.7.8-1"
