...
SRC_URI = "https://github.com/ros2-gbp/ament_lint-release/archive/release/dashing/ament_cmake_lint_cmake/0.7.8-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "89b458ebde84cd080ea355390ad88d1a"
SRC_URI[sha256sum] = "dbabbcd4a6eefb5caab09c92ee20700db3a268df2859986f78e2249670a28f46"
S = "${WORKDIR}/ament_lint-release-release-dashing-ament_cmake_lint_cmake-0.7.8-1"
