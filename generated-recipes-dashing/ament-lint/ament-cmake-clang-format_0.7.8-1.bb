...
SRC_URI = "https://github.com/ros2-gbp/ament_lint-release/archive/release/dashing/ament_cmake_clang_format/0.7.8-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "49b24c8229d54fdb3a923f07a683b860"
SRC_URI[sha256sum] = "5064eb96be255e2610518670dc0513cfba7eb12129ade00f63aad379d327c96c"
S = "${WORKDIR}/ament_lint-release-release-dashing-ament_cmake_clang_format-0.7.8-1"
