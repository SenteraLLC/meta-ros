...
SRC_URI = "https://github.com/ros2-gbp/ament_lint-release/archive/release/dashing/ament_uncrustify/0.7.8-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "4eb581ef7e3ee839af9a4efa2467f024"
SRC_URI[sha256sum] = "b434105bb168edd7a787e6dedd4cc8a5d0bed435e209ea18b2eb7474563e32ec"
S = "${WORKDIR}/ament_lint-release-release-dashing-ament_uncrustify-0.7.8-1"
