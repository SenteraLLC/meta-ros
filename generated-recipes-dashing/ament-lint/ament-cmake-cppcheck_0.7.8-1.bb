...
SRC_URI = "https://github.com/ros2-gbp/ament_lint-release/archive/release/dashing/ament_cmake_cppcheck/0.7.8-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "a15fef50277898e71b0b02b2b2364081"
SRC_URI[sha256sum] = "147dcd094c8a3a055d62ec1e8e9e8b4befac99d6e00d9ff76e1d9f489a26ab3d"
S = "${WORKDIR}/ament_lint-release-release-dashing-ament_cmake_cppcheck-0.7.8-1"
