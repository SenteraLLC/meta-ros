...
SRC_URI = "https://github.com/ros2-gbp/ament_lint-release/archive/release/dashing/ament_cmake_xmllint/0.7.8-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "261bf129876eb741197cb99e74b626ee"
SRC_URI[sha256sum] = "fd31c797722cb0da4d2e31570fd245a98dc02ea3d0f0be0681a2328187d7161c"
S = "${WORKDIR}/ament_lint-release-release-dashing-ament_cmake_xmllint-0.7.8-1"
