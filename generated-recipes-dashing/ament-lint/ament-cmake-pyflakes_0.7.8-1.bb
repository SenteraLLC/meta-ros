...
SRC_URI = "https://github.com/ros2-gbp/ament_lint-release/archive/release/dashing/ament_cmake_pyflakes/0.7.8-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "4d06db32701cc581944fd4a18cf950fa"
SRC_URI[sha256sum] = "7517ef13074fb47ef8b735c67d9d799dfe910a52aac280186abf6e97afd2d49e"
S = "${WORKDIR}/ament_lint-release-release-dashing-ament_cmake_pyflakes-0.7.8-1"
